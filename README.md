# BasicUtilR
# *R package* for visualization of multi-variate analysis for e.g. host-microbe interactions.

This repository contains an *R package* that can be used for analyzing multi-variate analysis from bacteria and host-microbe interactions using omics data. 
...
```
Now we can easily install *BasicUtilR*.
```
devtools::install_github("JacobAgerbo/BasicUtilR")
library(BasicUtilR)
```
