#' BasicUtilR - Perform Linear Mixed-Effects Modeling and Correlation Analysis
#' 
...
make_lme_cor <- function(data, 
  ...
  source("https://raw.githubusercontent.com/compbiomed/animalcules/master/R/utils.R")
