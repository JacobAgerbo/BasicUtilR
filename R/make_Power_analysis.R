#' BasicUtilR - Perform Power Analysis for Sample Size and Effect Size
...
#' make_Power(max_sample_size = 100, min_effect_size = 0.01, sig.level = 0.05, power = 0.8)
#' ```
#'
...
make_Power <- function(max_sample_size = 100, min_effect_size = 0.01, sig.level = 0.05, power = 0.8){
