...
#'
#' # Generate PCA plot
#' make_pca(data, sample_data = sample_data, group_var = "group", method = "euclidean", palette = "Dark2", alpha = 0.75, lg.position = "bottom", plot.centroids = FALSE, plot_title = "PCA Plot", scale = TRUE)
#' ```
#'
...
# Function to generate PCA plot
 make_pca <- function(data, sample_data = NULL, group_var = NULL, method = "euclidean", 
